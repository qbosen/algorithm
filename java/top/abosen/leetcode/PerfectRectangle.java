...
public class PerfectRectangle {
    public static void main(String[] args) {
        ...
        System.out.println(solution.isRectangleCover(new int[][]{{1, 1, 3, 3}, {3, 1, 4, 2}, {1, 3, 2, 4}, {3, 2, 4, 4}}));
        System.out.println(solution.isRectangleCover(new int[][]{{1, 1, 3, 3}, {3, 1, 4, 2}, {1, 3, 2, 4}, {2, 2, 4, 4}}));
        System.out.println(solution.isRectangleCover(new int[][]{{1, 1, 2, 2}, {1, 1, 2, 2}, {2, 1, 3, 2}}));
    }
